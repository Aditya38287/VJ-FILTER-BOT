...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002488461980 -1002352506605').split()]  # For Multiple Id Use One Space Between Each.
